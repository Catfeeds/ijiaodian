<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:55:"D:\wwwroot\gw.feiqqq.com/app/home\view\index_index.html";i:1512268635;s:55:"D:\wwwroot\gw.feiqqq.com/app/home\view\common_head.html";i:1512284646;s:57:"D:\wwwroot\gw.feiqqq.com/app/home\view\common_footer.html";i:1512269500;}*/ ?>
<!DOCTYPE html>
...
<div id="main">
	...
	<div class="case w1200">
		...
		<ul class="mc">
			...
			<li >
				<div class="img_box">
					<img src="/style/picture/274_thumb_g_1487720112812.jpg" alt="杭州和兴佬粽子">
				</div>
				<div class="case_info">
					<p class="title">杭州和兴佬粽子</p>
					<p class="label"><span>服务行业</span>食品餐饮</p>
				</div>
				<div class="case_action">
					<a href="goods.php?id=274" class="go_inside">查看价格</a>
					<a href="tencent://message/?uin=924101049&Site=金文勇&Menu=yes" class="go_plan">方案策划</a>
				</div>
			</li>
			...
			<li >
				<div class="img_box">
					<img src="/style/picture/324_thumb_g_1490142944515.jpg" alt="浙江舒蕊健康">
				</div>
				<div class="case_info">
					<p class="title">浙江舒蕊健康</p>
					<p class="label"><span>服务行业</span>广告咨询服务</p>
				</div>
				<div class="case_action">
					<a href="goods.php?id=324" class="go_inside">查看价格</a>
					<a href="tencent://message/?uin=924101049&Site=金文勇&Menu=yes" class="go_plan">方案策划</a>
				</div>
			</li>
			...
			<li >
				<div class="img_box">
					<img src="/style/picture/321_thumb_g_1490142061939.jpg" alt="美驰建材">
				</div>
				<div class="case_info">
					<p class="title">美驰建材</p>
					<p class="label"><span>服务行业</span>地产建材装修</p>
				</div>
				<div class="case_action">
					<a href="goods.php?id=321" class="go_inside">查看价格</a>
					<a href="ttencent://message/?uin=723788021&Site=小桔网络&Menu=yes" class="go_plan">方案策划</a>
				</div>
			</li>
			...
			<li class="mr_0">
				<div class="img_box">
					<img src="/style/picture/294_thumb_g_1490045373528.jpg" alt="精博康复辅具">
				</div>
				<div class="case_info">
					<p class="title">精博康复辅具</p>
					<p class="label"><span>服务行业</span>机械制造电子</p>
				</div>
				<div class="case_action">
					<a href="goods.php?id=294" class="go_inside">查看价格</a>
			...
			<li >
				<div class="img_box">
					<img src="/style/picture/309_thumb_g_1490134552326.jpg" alt="大美文化">
				</div>
				<div class="case_info">
					<p class="title">大美文化</p>
					<p class="label"><span>服务行业</span>艺术教育培训</p>
				</div>
				<div class="case_action">
					<a href="goods.php?id=309" class="go_inside">查看价格</a>
					<a href="ttencent://message/?uin=723788021&Site=小桔网络&Menu=yes" class="go_plan">方案策划</a>
				</div>
			</li>
			...
			<li >
				<div class="img_box">
					<img src="/style/picture/272_thumb_g_1487644813990.jpg" alt="浙西大龙湾">
				</div>
				<div class="case_info">
					<p class="title">浙西大龙湾</p>
					<p class="label"><span>服务行业</span>酒店旅游</p>
				</div>
				<div class="case_action">
					<a href="goods.php?id=272" class="go_inside">查看价格</a>
					<a href="tencent://message/?uin=723788021&Site=小桔网络&Menu=yes" class="go_plan">方案策划</a>
				</div>
			</li>
			...
			<li >
				<div class="img_box">
					<img src="/style/picture/301_thumb_g_1490059382612.jpg" alt="浙江九钢金属">
				</div>
				<div class="case_info">
					<p class="title">浙江九钢金属</p>
					<p class="label"><span>服务行业</span>机械制造电子</p>
				</div>
				<div class="case_action">
					<a href="goods.php?id=301" class="go_inside">查看价格</a>
					<a href="tencent://message/?uin=723788021&Site=应洁&Menu=yes" class="go_plan">方案策划</a>
				</div>
			</li>
			...
			<li class="mr_0">
				<div class="img_box">
					<img src="/style/picture/275_thumb_g_1489195822177.jpg" alt="张宁体育文化发展（北京）有限公司">
				</div>
				<div class="case_info">
					<p class="title">张宁体育文化发展（北京）有限公司</p>
					<p class="label"><span>服务行业</span>品牌个性化</p>
				</div>
				<div class="case_action">
					<a href="goods.php?id=275" class="go_inside">查看价格</a>
					<a href="tencent://message/?uin=723788021&Site=小桔网络&Menu=yes" class="go_plan">方案策划</a>
				</div>
			</li>
			...
			<li >
				<div class="img_box">
					<img src="/style/picture/287_thumb_g_1490036503903.jpg" alt="中乡创投资（集团）">
				</div>
				<div class="case_info">
					<p class="title">中乡创投资（集团）</p>
					<p class="label"><span>服务行业</span>广告咨询服务</p>
				</div>
				<div class="case_action">
					<a href="goods.php?id=287" class="go_inside">查看价格</a>
					<a href="tencent://message/?uin=723788021&Site=小桔网络&Menu=yes" class="go_plan">方案策划</a>
				</div>
			</li>
			...
			<li >
				<div class="img_box">
					<img src="/style/picture/307_thumb_g_1490122530766.jpg" alt="浙江金牌商标">
				</div>
				<div class="case_info">
			...
			<li >
				<div class="img_box">
					<img src="/style/picture/279_thumb_g_1488503079445.jpg" alt="泛泛海淘">
				</div>
				<div class="case_info">
					<p class="title">泛泛海淘</p>
					<p class="label"><span>服务行业</span>品牌个性化</p>
				</div>
				<div class="case_action">
					<a href="goods.php?id=279" class="go_inside">查看价格</a>
					<a href="ttencent://message/?uin=723788021&Site=小桔网络&Menu=yes" class="go_plan">方案策划</a>
				</div>
			</li>
			...
			<li class="mr_0">
				<div class="img_box">
					<img src="/style/picture/288_thumb_g_1490037271002.jpg" alt="北京宏天信业">
				</div>
				<div class="case_info">
					<p class="title">北京宏天信业</p>
					<p class="label"><span>服务行业</span>科技</p>
				</div>
				<div class="case_action">
					<a href="goods.php?id=288" class="go_inside">查看价格</a>
					<a href="tencent://message/?uin=723788021&Site=小桔网络&Menu=yes" class="go_plan">方案策划</a>
				</div>
			</li>
...
<div id="footer">
    ...
    $('#buttonsend').click(function(){
        ...
        $.post("<?php echo url('senMsg'); ?>",{tel:phone,content:content},function(data){
            if(data.status==1){
