<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"C:\phpStudy\WWW\MyProject\ijiaodian/app/home\view\case_list.html";i:1512618373;s:66:"C:\phpStudy\WWW\MyProject\ijiaodian/app/home\view\common_head.html";i:1512284646;s:68:"C:\phpStudy\WWW\MyProject\ijiaodian/app/home\view\common_footer.html";i:1512621640;}*/ ?>
<!DOCTYPE html>
	...
	<div class="w1200">
			...
			<div class="goods_category">
				<div class="goods_category">
					...
					<?php if(is_array($cates) || $cates instanceof \think\Collection || $cates instanceof \think\Paginator): $i = 0; $__LIST__ = $cates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
						<a href="/home/case/index/catId/<?php echo $v['id']; ?>.html" title="<?php echo $v['catname']; ?>"><?php echo $v['catname']; ?></a>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
					</nav>
				</div>

				<div class="mt"><p>案例分类</p></div>
				<nav class="mc clearfix">
					<?php if(is_array($sub_cates) || $sub_cates instanceof \think\Collection || $sub_cates instanceof \think\Paginator): $i = 0; $__LIST__ = $sub_cates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?>
						<a href="/home/case/index/catId/<?php echo $r['id']; ?>.html" title="<?php echo $r['catname']; ?>"><?php echo $r['catname']; ?></a>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        <li>
		  ...
		  <div class="case_info">
		    ...
		    <p class="label"><span>服务行业</span><?php echo $vo['jigou']; ?></p>
		  </div>
		  <div class="case_action">
		    <a href="<?php echo url('home/'.$vo['controller'].'/info',array('id'=>$vo['id'],'catId'=>$vo['catid'])); ?>" class="go_inside">查看价格</a>
		    <a href="http://wpa.qq.com/msgrd?v=3&uin=723788021&site=www.ijiaodian.cn&menu=yes" class="go_plan">方案策划</a>
		  </div>
		</li>
        <?php endforeach; endif; else: echo "" ;endif; ?>	
