<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"C:\phpStudy\WWW\MyProject\ijiaodian/app/admin\view\link\index.html";i:1504236308;s:67:"C:\phpStudy\WWW\MyProject\ijiaodian/app/admin\view\common\head.html";i:1505459050;s:67:"C:\phpStudy\WWW\MyProject\ijiaodian/app/admin\view\common\foot.html";i:1503623995;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="admin-main layui-anim layui-anim-upbit">
    ...
    <blockquote class="layui-elem-quote">
        <a href="<?php echo url('add'); ?>" class="layui-btn layui-btn-small"><?php echo lang('add'); ?>友链</a>
...
<script type="text/html" id="action">
    <a href="<?php echo url('edit'); ?>?link_id={{d.link_id}}" class="layui-btn layui-btn-mini">编辑</a>
    ...
    layui.use('table', function() {
        ...
        table.on('tool(list)', function(obj) {
            ...
            if (obj.event === 'open') {
                ...
                $.post('<?php echo url("linkState"); ?>', {'id': data.link_id}, function (res) {
                    layer.close(loading);
                    if (res.status === 1) {
                        if (res.open === 1) {
                            obj.update({
