<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"D:\wwwroot\gw.feiqqq.com/app/home\view\page_show_contace.html";i:1512278827;s:55:"D:\wwwroot\gw.feiqqq.com/app/home\view\common_head.html";i:1512284646;s:57:"D:\wwwroot\gw.feiqqq.com/app/home\view\common_footer.html";i:1512269500;}*/ ?>
<!DOCTYPE html>
...
<div id="contact">
	<section class="contact_banner"></section>
	<div class="w1200 contact">
		<div class="contact_box">
			<p class="title">杭州开创网络技术有限公司<span>HANGZHOU KAICHUANG NETWORK TECHNOLOGY CO., LTD</span></p>
			<div class="mc clearfix">
				<p class="tel">400-068-3318</p>
				<p>电　话：0571-87210028　0571-87211100</p>
				<p>传　真：0571-87211100　0571-87081680</p>
				<p>地　址：杭州市解放路26号金衙庄大厦11楼D-F座</p>
				<p>邮　箱：Eileen@hzkc.cn</p>
			</div>
		</div>
		<div class="pay_box">
			<p class="title">支付方式</p>
			<div class="mc">
				单位名称：杭州开创网络技术有限公司</br>
				开户银行：工行解放路支行</br>
				帐号：1202020709906620903
			</div>
			<p class="title" style="margin-top: 32px;">以下是开创网络授权转账的个人账户：</p>
			<div class="mc">
				姓名：方玮玲</br>
				农行（浙江省营业中心）62284 80320 10544 0111</br>
				招行（官巷口支行）4682 0358 6868 1688</br>
				工行（城站支行）622202 120200 2870948</br>
				建行（宝石支行）43674 21540 01020 7541</br>
				支付宝账户：Eileen@guide.net.cn
			</div>
		</div>
		<div class="alipy_box">
			<img src="picture/pay_phone_alipy.png">
		</div>
	</div>
</div>
<div id="allmap" style="width: 70%;margin: 0 auto;margin-bottom: 20px;"></div>
<script type="text/javascript" src="/style/js/36bcafc73b80472aabe86cabaed935af.js"></script>
<script type="text/javascript" src="/style/js/8968b1e96b9e46e8aeb4ff1a45ce88e2.js"></script>
<script>
...
var point = new BMap.Point(120.191329,30.255493);
map.centerAndZoom(point, 19);
var marker = new BMap.Marker(point);  // 创建标注
map.addOverlay(marker);              // 将标注添加到地图中

var label = new BMap.Label("焦点科技网络", {offset: new BMap.Size(-68, -56)});
