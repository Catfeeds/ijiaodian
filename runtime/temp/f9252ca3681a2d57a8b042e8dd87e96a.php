<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"C:\phpStudy\WWW\MyProject\ijiaodian/app/admin\view\ad\index.html";i:1505099370;s:67:"C:\phpStudy\WWW\MyProject\ijiaodian/app/admin\view\common\head.html";i:1505459050;s:67:"C:\phpStudy\WWW\MyProject\ijiaodian/app/admin\view\common\foot.html";i:1503623995;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script type="text/html" id="action">
    <a href="<?php echo url('edit'); ?>?ad_id={{d.ad_id}}" class="layui-btn layui-btn-mini">编辑</a>
    ...
    layui.use('table', function() {
        ...
        table.on('tool(list)', function(obj) {
            ...
            if (obj.event === 'open') {
                ...
                $.post('<?php echo url("editState"); ?>', {'id': data.ad_id}, function (res) {
                    layer.close(loading);
                    if (res.status === 1) {
                        if (res.open === 1) {
                            obj.update({
