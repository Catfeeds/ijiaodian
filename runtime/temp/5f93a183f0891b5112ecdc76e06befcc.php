<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"C:\phpStudy\WWW\MyProject\ijiaodian/app/home\view\case_show.html";i:1512621702;s:66:"C:\phpStudy\WWW\MyProject\ijiaodian/app/home\view\common_head.html";i:1512284646;s:68:"C:\phpStudy\WWW\MyProject\ijiaodian/app/home\view\common_footer.html";i:1512621640;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="goods_left">
      <div class="goods_main_box bg_white">
        <article>
          ...
          <time class="upload_time">上传时间：<?php echo date('Y-m-d',$info['createtime']); ?></time>
          <aside>
            
            <div class="goods_information clearfix">
              <p><span>服务行业：</span><?php echo $info['hangye']; ?></p>
              <p><span>项目周期：</span><?php echo $info['day']; ?></p>
              <p><span>参与人数：</span><?php echo $info['renshu']; ?></p>
              <p><span>项目费用：</span>￥<?php echo $info['price']; ?></p>
            </div>
            <p class="goods_desc">
          ...
          <div class="goods_main">
			<?php if(is_array($info['pics']) || $info['pics'] instanceof \think\Collection || $info['pics'] instanceof \think\Paginator): $i = 0; $__LIST__ = $info['pics'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			<p style="text-align:center;">
				<img src="/public<?php echo $vo; ?>" alt="" />
			</p>
			<?php endforeach; endif; else: echo "" ;endif; ?>
          </div>
        </article>
        <div class="goods_action">
          <a href="<?php echo $info['url']; ?>" class="action_see" target="_blank"><i></i></a>
...
<!--<div class="goods_reply_box bg_white">
  ...
  <div class="mc">
    ...
    $('#lianxi').click(function(){
        ...
        $.post("<?php echo url('/home/index/callMe'); ?>",{tel:phone,cehua:cehua},function(data){
            if(data.status==1){
                alert('留言成功！将会尽快给你回复！');
                location.reload();
            }else{
      ...
      <section class="case">
        ...
        <div class="mc" id="customer_box">
            ...
            <p class="title"><a href="<?php echo url('home/'.$vo['catdir'].'/info',array('id'=>$vo['id'],'catId'=>$vo['catid'])); ?>"><?php echo $vo['title']; ?></a></p>
            <p class="tap">服务行业：<?php echo $vo['hangye']; ?>
            </p>
        	</article>
            <?php endforeach ?>
            </div>
