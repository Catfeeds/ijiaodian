...
Source Database       : jiaodian

Target Server Type    : MYSQL
Target Server Version : 50635
File Encoding         : 65001

Date: 2017-12-08 16:08:50
*/
...
INSERT INTO `clt_auth_rule` VALUES ('3', 'Database/database', '数据库管理', '1', '1', '0', 'icon-database', '', '0', '7', '1446535805', '1', '1');
...
INSERT INTO `clt_auth_rule` VALUES ('7', 'Category', '栏目管理', '1', '1', '0', 'icon-list', '', '0', '1', '1446535875', '1', '1');
...
INSERT INTO `clt_auth_rule` VALUES ('15', 'Auth/adminList', '权限管理', '1', '1', '0', 'icon-lifebuoy', '', '0', '10', '1446535750', '1', '1');
...
INSERT INTO `clt_auth_rule` VALUES ('27', 'Users', '会员管理', '1', '1', '0', 'icon-user', '', '0', '2', '1447231507', '1', '1');
INSERT INTO `clt_auth_rule` VALUES ('28', 'Function', '网站功能', '1', '1', '0', 'icon-cog', '', '0', '3', '1447231590', '1', '1');
...
INSERT INTO `clt_auth_rule` VALUES ('189', 'Module', '模型管理', '1', '1', '0', 'icon-ungroup', '', '0', '6', '1466825363', '0', '1');
...
INSERT INTO `clt_auth_rule` VALUES ('266', 'Wechat/news', '多图文回复', '1', '1', '0', '', '', '206', '7', '1501221710', '0', '0');
...
-- ----------------------------
-- Table structure for `clt_call`
-- ----------------------------
DROP TABLE IF EXISTS `clt_call`;
CREATE TABLE `clt_call` (
  `message_id` int(11) NOT NULL AUTO_INCREMENT,
  `tel` varchar(15) NOT NULL COMMENT '留言电话',
  ...
  `ceshua` varchar(60) DEFAULT NULL,
...
-- Records of clt_call
-- ----------------------------
INSERT INTO `clt_call` VALUES ('34', '13160656565', '1512269561', '0', '116.28.3.249', null, null);
INSERT INTO `clt_call` VALUES ('35', '23123123', '1512276149', '0', '183.45.186.115', null, null);

-- ----------------------------
-- Table structure for `clt_case`
-- ----------------------------
...
CREATE TABLE `clt_case` (
  ...
  `catid` smallint(5) unsigned NOT NULL DEFAULT '0',
  `content` text NOT NULL,
  `day` varchar(255) NOT NULL DEFAULT '1个月',
  `renshu` varchar(255) NOT NULL DEFAULT '1人',
  `price` varchar(255) NOT NULL DEFAULT '10000元',
  `hangye` varchar(255) NOT NULL DEFAULT '',
...
-- Records of clt_case
-- ----------------------------
INSERT INTO `clt_case` VALUES ('1', '测试产品', 'color:;font-weight:normal;', '/uploads/20171203/5896ebc131321c64c4f0938559928cd3.jpg', '9', '1', '1', 'admin', '0', '1512273456', '1512274850', '0', '', '北京城建', '11', '<p>测试</p>', '10天', '11', '2000', '农业', '/uploads/20171203/aed0c10bd93a7ad3641649a0f272c154.png;/uploads/20171203/cf5277b90e405a8b4b6ac52c0d094ccb.jpg;', '', '0');
INSERT INTO `clt_case` VALUES ('2', '测试2', 'color:;font-weight:normal;', '/uploads/20171203/b4918cecf048078623c30ab333cbc9eb.png', '48', '1', '1', 'admin', '0', '1512274150', '1512276683', '0', '', '重启专业技术', '12', '<p>测试内222<br/></p>', '1个月', '1人', '10000元', '电子商务', '/uploads/20171203/a5f48dfa054e39e4de732a55925b9beb.png;/uploads/20171203/2544992748e4fa7fe648c0867b22024f.png;/uploads/20171203/795ac03753658d2e21966d362b1acca3.png;', 'http://www.baidu.com', '2');
...
-- ----------------------------
INSERT INTO `clt_category` VALUES ('2', '介绍', 'about', '', '0', '1', 'page', '0', '2', '0', '关于我们', '关于我们', '关于我们', '3', '0', '1', '0', '', '0', '', 'page_show_about', 'page_show_about', '0', '', '0', '0');
INSERT INTO `clt_category` VALUES ('4', '案例', 'case', '', '0', '10', 'case', '0', '4,10,11,12,13', '0', '客户案例', '客户案例', '客户案例', '1', '0', '1', '0', '', '0', '', '', '', '0', '1,2,3', '0', '0');
INSERT INTO `clt_category` VALUES ('9', '服务', 'service', '', '0', '1', 'page', '0', '9', '0', '', '', '', '2', '0', '1', '0', '', '0', '', 'page_show_service', 'page_show_service', '0', '1,2,3', '0', '0');
INSERT INTO `clt_category` VALUES ('8', '联系', 'contact', '', '0', '1', 'page', '0', '8', '0', '联系我们', '联系我们', '联系我们', '4', '0', '1', '0', '', '0', '', 'page_show_contace', 'page_show_contace', '0', '', '0', '0');
INSERT INTO `clt_category` VALUES ('10', '微擎开发', 'weiqing', 'case/', '4', '10', 'case', '0,4', '10,11,12', '0', '', '', '', '0', '0', '1', '0', '', '0', '', '', '', '0', '', '0', '0');
INSERT INTO `clt_category` VALUES ('11', '人人商城', 'renren', 'case/weiqing/', '10', '10', 'case', '0,4,10', '11', '0', '', '', '', '0', '0', '1', '0', '', '0', '', '', '', '0', '', '0', '0');
INSERT INTO `clt_category` VALUES ('12', '啦啦外卖', 'lala', 'case/weiqing/', '10', '10', 'case', '0,4,10', '12', '0', '', '', '', '0', '0', '1', '0', '', '0', '', '', '', '0', '', '0', '0');
INSERT INTO `clt_category` VALUES ('13', '微信开发', 'weixin', 'case/', '4', '10', 'case', '0,4', '13', '0', '', '', '', '0', '0', '1', '0', '', '0', '', '', '', '0', '', '0', '0');
...
INSERT INTO `clt_field` VALUES ('83', '1', 'ceshi', 'ceshi', '', '1', '0', '0', 'defaul', '', 'ceshi', 'text', 'array (\n  \'default\' => \'\',\n  \'ispassword\' => \'0\',\n  \'fieldtype\' => \'varchar\',\n)', '0', '', '0', '1', '0');
INSERT INTO `clt_field` VALUES ('84', '10', 'title', '标题', '', '1', '1', '80', '', '标题必须为1-80个字符', '', 'title', 'array (\n  \'thumb\' => \'1\',\n  \'style\' => \'1\',\n  \'size\' => \'55\',\n)', '1', '', '1', '1', '1');
INSERT INTO `clt_field` VALUES ('85', '10', 'hits', '点击次数', '', '0', '0', '8', '', '', '', 'number', 'array (\n  \'size\' => \'10\',\n  \'numbertype\' => \'1\',\n  \'decimaldigits\' => \'0\',\n  \'default\' => \'0\',\n)', '1', '', '8', '0', '0');
INSERT INTO `clt_field` VALUES ('86', '10', 'createtime', '发布时间', '', '1', '0', '0', 'date', '', '', 'datetime', '', '1', '', '97', '1', '1');
INSERT INTO `clt_field` VALUES ('87', '10', 'template', '模板', '', '0', '0', '0', '', '', '', 'template', '', '1', '', '99', '0', '1');
INSERT INTO `clt_field` VALUES ('88', '10', 'status', '状态', '', '0', '0', '0', '', '', '', 'radio', 'array (\n  \'options\' => \'发布|1\r\n定时发布|0\',\n  \'fieldtype\' => \'tinyint\',\n  \'numbertype\' => \'1\',\n  \'labelwidth\' => \'75\',\n  \'default\' => \'1\',\n)', '1', '', '98', '1', '1');
INSERT INTO `clt_field` VALUES ('90', '10', 'jigou', '机构名称', '', '0', '0', '0', 'defaul', '', 'jigou', 'text', 'array (\n  \'default\' => \'\',\n  \'ispassword\' => \'0\',\n  \'fieldtype\' => \'varchar\',\n)', '0', '', '2', '1', '0');
INSERT INTO `clt_field` VALUES ('98', '10', 'images', '演示图片', '', '0', '0', '0', 'defaul', '', 'images', 'images', '', '0', '', '4', '1', '0');
INSERT INTO `clt_field` VALUES ('99', '10', 'url', '演示网址', '', '0', '0', '0', 'defaul', '', 'url', 'text', 'array (\n  \'default\' => \'\',\n  \'ispassword\' => \'0\',\n  \'fieldtype\' => \'varchar\',\n)', '0', '', '6', '1', '0');
INSERT INTO `clt_field` VALUES ('92', '10', 'catid', '上级栏目', '', '1', '0', '0', 'defaul', '', 'catid', 'catid', '', '0', '', '3', '1', '0');
INSERT INTO `clt_field` VALUES ('93', '10', 'content', '内容', '', '1', '0', '0', 'defaul', '', 'content', 'editor', 'array (\n  \'edittype\' => \'UEditor\',\n)', '0', '', '5', '1', '0');
INSERT INTO `clt_field` VALUES ('97', '10', 'hangye', '服务行业', '', '0', '0', '0', 'defaul', '', 'hangye', 'text', 'array (\n  \'default\' => \'\',\n  \'ispassword\' => \'0\',\n  \'fieldtype\' => \'varchar\',\n)', '0', '', '3', '1', '0');
INSERT INTO `clt_field` VALUES ('94', '10', 'day', '项目周期', '', '1', '0', '0', 'defaul', '', 'day', 'text', 'array (\n  \'default\' => \'1个月\',\n  \'ispassword\' => \'0\',\n  \'fieldtype\' => \'varchar\',\n)', '0', '', '3', '1', '0');
INSERT INTO `clt_field` VALUES ('95', '10', 'renshu', '参与人数', '', '1', '0', '0', 'defaul', '', 'renshu', 'text', 'array (\n  \'default\' => \'1人\',\n  \'ispassword\' => \'0\',\n  \'fieldtype\' => \'varchar\',\n)', '0', '', '3', '1', '0');
INSERT INTO `clt_field` VALUES ('96', '10', 'price', '项目费用', '', '1', '0', '0', 'defaul', '', 'price', 'text', 'array (\n  \'default\' => \'10000元\',\n  \'ispassword\' => \'0\',\n  \'fieldtype\' => \'varchar\',\n)', '0', '', '3', '1', '0');
INSERT INTO `clt_field` VALUES ('100', '10', 'posid', '推荐位', '', '1', '0', '0', 'defaul', '', 'posid', 'posid', '', '0', '', '7', '1', '0');
...
-- ----------------------------
INSERT INTO `clt_message` VALUES ('35', null, '12312312', '1512276176', '0', '183.45.186.115', '3121131', null, null);
INSERT INTO `clt_message` VALUES ('34', null, '13160656565', '1512269561', '0', '116.28.3.249', '23123123', null, null);
...
CREATE TABLE `clt_module` (
  ...
  `type` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `issystem` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `listfields` varchar(255) DEFAULT NULL,
  `setup` text,
...
INSERT INTO `clt_module` VALUES ('10', '案例模型', 'case', '案例模型', '1', '0', '*', null, '0', '1');
...
CREATE TABLE `clt_page` (
  ...
  `lang` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `content` text NOT NULL,
  `ceshi` varchar(255) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
...
INSERT INTO `clt_page` VALUES ('9', '服务', '', '', '0', '0', '0', '', '0', '0', '0', '0', '', '');
...
-- ----------------------------
INSERT INTO `clt_picture` VALUES ('1', '4', '1', 'admin', '模型列表', '模型列表', '展示网站内容模型，模型是CLTPHP的核心之一。', '<p>展示网站内容模型，模型是CLTPHP的核心之一。</p>', '0', '0', '1', '0', '', '0', '1', '0', '1499761915', '1504518767', '/uploads/20170904/f5a33a284f8036c3a086f2829f98599b.png', '1');
...
-- ----------------------------
INSERT INTO `clt_plugin` VALUES ('qq', 'QQ登陆', '1.0', '褫憷', 'a:2:{i:0;a:4:{s:4:\"name\";s:6:\"app_id\";s:5:\"label\";s:6:\"app_id\";s:4:\"type\";s:4:\"text\";s:5:\"value\";s:0:\"\";}i:1;a:4:{s:4:\"name\";s:10:\"app_secret\";s:5:\"label\";s:10:\"app_secret\";s:4:\"type\";s:4:\"text\";s:5:\"value\";s:0:\"\";}}', null, 'QQ登陆插件 ', '1', 'login', 'logo.png', 'N;', null);
...
-- ----------------------------
INSERT INTO `clt_system` VALUES ('1', '重庆焦点科技网络有限公司', 'http://www.ijiaodian.com/', '重庆焦点科技网络有限公司', '重庆焦点科技网络有限公司', '重庆焦点科技网络有限公司', '陕ICP备15008093号-3', '2015-2020', '重庆市涪陵区泽胜中央广场A栋22楼B区', '400-023-5868', '455623609@qq.com', '/uploads/20170904/9f04d8be2a05d926bc3e328eded02378.png');
...
INSERT INTO `clt_users` VALUES ('2595', '1109305987@qq.com', 'e10adc3949ba59abbe56e057f20f883e', null, '1', '0', '1504510472', '0', '', '', '18792402229', '0', '', null, null, '/uploads/20170904/c9a67df7424692b8ce783c45f9bcd40a.jpg', '3', '37', '410', '0', 'chichu', '1', '0', 'b1dbf9f02a1d638f69fd017843140717', '不要因为走得太远，就忘了当初为什么出发。', 'hide');
...
-- ----------------------------
-- Table structure for `clt_wx_img`
-- ----------------------------
...
-- ----------------------------
-- Records of clt_wx_img
-- ----------------------------
INSERT INTO `clt_wx_img` VALUES ('3', '手册', '手册', '', 'https://www.kancloud.cn/chichu/cltphp', '1487645725', '', '手册');

-- ----------------------------
-- Table structure for `clt_wx_keyword`
-- ----------------------------
...
-- ----------------------------
-- Table structure for `clt_wx_news`
-- ----------------------------
...
-- ----------------------------
INSERT INTO `clt_wx_user` VALUES ('1', '0', 'CLTPHP', '', '0', 'wx08c8be07451213255', '2e6f2d97d605sad5gjkk532d14ddc', 'gh_8a8sadn80bn9', 'cvookg', 'sdfdsfdsfdsf', 'cltphp', '0', '0', '', '', '', '', '', '', '1', 'eY9W4LLdISpE3UtTfuodgz1HJdBYCMbzZWkiLEhF0Nzvzv2q2DtGIV5h7CPrc0Nd4_kJgKN_FdM3kNaCxfFC1wmu6JLnNoOrmMuy3FK2AhMDLCbAGAXFW', '', '1504242136', '0', '0', '欢迎来到CLTPHP！CLTPHP采用ThinkPHP5作为基础框架，同时采用Layui作为后台界面，使得CLTPHP适用与大型企业网站、个人博客论坛、企业网站、手机网站的定制开发。更高效、更快捷的进行定制开发一直是CLTPHP追求的价值。', '亲！您可以输入关键词来获取您想要知道的内容。（例：手册）');
